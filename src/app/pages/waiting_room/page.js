...
export default function WaitingRoom() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      setQuizCode(localStorage.getItem("inviteCode"));
      setIsLoading(false);
    }
  }, []);
  ...
  useEffect(() => {
    ...
    const gameStartRef = ref(database, `quizzes/${quizCode}/game_start`);
          ...
          <div className={CONTAINER_STYLES.quizInfo}>
            ...
            <div className={CONTAINER_STYLES.infoGrid}>
              ...
              <div className={CONTAINER_STYLES.infoCard}>
                ...
                <span className={CONTAINER_STYLES.infoValue}>$0</span>
              </div>
            </div>
          </div>
        </div>
